...
int main()
{
    ...
    vector<string> vect;
    string DriverInfLoc, PortNames, PortNameAndNumber, install_printer;
    ...
    string ServerIP = reader.Get("Server", "serverIP", "127.0.0.1");
    ...
    string IP = reader.Get("Printer", "IP", "UNKNOWN");
